  ...
  return (
    <nav className="nav navAnywhere bg-cream/80 backdrop-blur-md">
      ...
      <ul className="flex flex-row gap-8 items-center">
        ...
        <li className="flex items-center"><a href="#contact"><button className="btnSmall bg-aquaT rounded-2xl py-1.5 px-8 text-gray-50 font-medium text-lg">Contate-me</button></a></li>
      </ul>
    </nav>
  );
}